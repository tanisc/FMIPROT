...
Edit `ml_cnn_large_kernel_1.sh` to provide the Python path for the newly created conda environment.
...
```text
src/plugins/ml_cnn_large_kernel_1
├── conda_env.yml
├── ml_cnn_large_kernel_1.py
├── ml_cnn_large_kernel_1.sh
├── models
│   ├── 3_ConVlayer_adam
│   ├── 3_dense_reg
│   ├── cropped_3
