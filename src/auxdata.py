...
"FMIPROT Time series results - Snow Cover Fraction":{"settings":{"datadir":"None"},"metadata":{'valuetype':'continuous','temporal':'timeseries','resolution':'100','valuerange':'0/1','valuescale':'1','valuebias':'0','invisvalue':'-1','invisthreshold':'1.0','classnames':'','classvalues':''}},\
"MONIMET Visual observations - Snow Cover Fraction":{"settings":{"datadir":"None"},"metadata":{'valuetype':'continuous','temporal':'timeseries','resolution':'100','valuerange':'0/100','valuescale':'0.01','valuebias':'0','invisvalue':'-1','invisthreshold':'1.0','classnames':'','classvalues':''}},\
