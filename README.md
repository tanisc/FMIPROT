...
(7) Georectification: Creates orthoimages and weightmasks by orthorectifying camera images. (Not applicable for too many images, mainly intended to be included as a part of snow cover fraction algorithms and other testing purposes.)
***************************************************************
AUTHORS
...
***************************************************************
For detailed documentation and tutorials, refer to usermanual.pdf and https://fmiprot.fmi.fi.
***************************************************************
